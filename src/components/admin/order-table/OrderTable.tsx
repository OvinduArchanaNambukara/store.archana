...
import Id from "../product-table/Id";
import Category from "../product-table/Category";
...
const OrderTable: React.FC = () => {
  ...
  const allPendingOrders: QueryResult = useQuery(GET_ALL_PENDING_ORDERS);
  ...
  useEffect(() => {
    ...
    setAllCompletedTableList(createOrderTableList(allCompletedOrders.data.getAllCompletedOrders));
